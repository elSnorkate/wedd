  ...
  return (
   ...
   <div className='timeline'>
    ...
    <div className='container right-continer'>
      ...
      <div className='text-box'>
        <h2 className='tH2'>Sesion de fotos</h2>
        <small>12:30</small>
